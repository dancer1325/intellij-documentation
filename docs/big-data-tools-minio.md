[//]: # (Source: https://www.jetbrains.com/help/idea/big-data-tools-minio.html)
[//]: # (Downloaded: 2025-12-17 19:19:11)
...
### Connect to MinIO
  ...
  1. In the Big Data Tools window, click ![Add a connection](https://resources.jetbrains.com/help/img/idea/2025.3/app-client.expui.general.add.svg) and select MinIO.

  2. In the Big Data Tools dialog that opens, specify the connection parameters:

![Configure MinIO connection](https://resources.jetbrains.com/help/img/idea/2025.3/bdt_minio.png)
...
You can also set up Extended Connection Settings:
     ...
     * Region: enter the custom region.
...
[Linode](big-data-tools-linode.html)[Tencent COS](big-data-tools-tencent-cos.html)
