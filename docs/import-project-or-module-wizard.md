[//]: # (Source: https://www.jetbrains.com/help/idea/import-project-or-module-wizard.html)
[//]: # (Downloaded: 2025-12-17 19:29:19)

## Open a project (simple import)

This option imports the selected project to IntelliJ IDEA as is (opens it). If you want to set custom settings while importing the project (for example, select another SDK or choose the libraries that you want to import), refer to [Create a project from existing sources](#create-from-sources).
