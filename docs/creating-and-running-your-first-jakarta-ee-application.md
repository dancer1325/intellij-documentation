[//]: # (Source: https://www.jetbrains.com/help/idea/creating-and-running-your-first-jakarta-ee-application.html)
[//]: # (Downloaded: 2025-12-17 19:23:23)
...
If you see an error message like `Unable to connect to the localhost:1099` when trying to deploy the application on a remote Tomcat server, try these steps:
  ...
  * Make sure the Tomcat server is running. For example, launch the local Tomcat run configuration [described above](#run_config).
