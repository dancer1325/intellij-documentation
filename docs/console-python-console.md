[//]: # (Source: https://www.jetbrains.com/help/idea/console-python-console.html)
[//]: # (Downloaded: 2025-12-17 19:22:23)
...
To open the Python Console, select View | Tool Windows | Python Console in the main menu.
...
[Console](console.html)[Console. Django Console and manage.py options](console-django-console.html)
