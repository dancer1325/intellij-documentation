[//]: # (Source: https://www.jetbrains.com/help/idea/big-data-tools-digitalocean-spaces.html)
[//]: # (Downloaded: 2025-12-17 19:18:58)
...
### Connect to DigitalOcean Spaces
  ...
  1. In the Big Data Tools window, click ![Add a connection](https://resources.jetbrains.com/help/img/idea/2025.3/app-client.expui.general.add.svg) and select DigitalOcean Spaces.

  2. In the Big Data Tools dialog that opens, specify the connection parameters:

![Configure DigitalOcean Spaces connection](https://resources.jetbrains.com/help/img/idea/2025.3/bdt_digital_ocean_space.png)
...
[Cloudflare R2](big-data-tools-cloudflare-r2.html)[Google Cloud Storage](big-data-tools-google-cloud-storage.html)
