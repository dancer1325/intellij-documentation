[//]: # (Source: https://www.jetbrains.com/help/idea/run-debug-configuration-jar.html)
[//]: # (Downloaded: 2025-12-17 19:58:10)

## Configuration tab

Item| Description  
---|---  
Path to JAR| Specify the absolute path to the required JAR file.  
