[//]: # (Source: https://www.jetbrains.com/help/idea/selenium.html)
[//]: # (Downloaded: 2025-12-17 20:00:07)
...
![Creating a new Selenium project](https://resources.jetbrains.com/help/img/idea/2025.3/selenium-new-project.png)
...
![Adding dependencies](https://resources.jetbrains.com/help/img/idea/2025.3/selenium_new_project_dependencies.png)
  13. Click Create.
...
![Creating a new Selenium with Pytest project](https://resources.jetbrains.com/help/img/idea/2025.3/ij_selenium_pytest_virtualenv.png)
  3. Name the new project and change its location if necessary.
...
![Configure a new Conda environment](https://resources.jetbrains.com/help/img/idea/2025.3/ij_selenium_pytest_conda.png)
...
![Configure a new Pipenv environment](https://resources.jetbrains.com/help/img/idea/2025.3/ij_selenium_pytest_pipenv.png)
...
![Configure a new Poetry environment](https://resources.jetbrains.com/help/img/idea/2025.3/ij_selenium_pytest_poetry.png)
     * Select the base interpreter from the list or click ![Browse...](https://resources.jetbrains.com/help/img/idea/2025.3/app.expui.inline.browse.svg) and find the Python executable in your file system.

For more information, refer to the [PyCharm documentation](https://www.jetbrains.com/help/pycharm/poetry.html).

![Configure an existing environment](https://resources.jetbrains.com/help/img/idea/2025.3/ij_selenium_pytest_existing_env.png)
