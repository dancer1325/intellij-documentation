[//]: # (Source: https://www.jetbrains.com/help/idea/xpath-plugin-settings.html)
[//]: # (Downloaded: 2025-12-17 20:07:48)
...
XPathView plugin settings are configured on the [XPath Viewer](xpath-viewer.html) page of the [Settings](settings-preferences-dialog.html) dialog.
...
[XPath expression generation](xpath-expression-generation.html)[XSLT run configurations](xslt-run-configurations.html)
